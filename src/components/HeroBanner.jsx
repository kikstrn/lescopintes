...
function HeroBanner({ onCreateEvent, onAddScore }) {
  return (
    <section className="hero-banner">
      ...
      >
        <div className="hero-banner__status">
          ...
          <span>La saison 2026 est lancée</span>
        </div>

        <p className="hero-banner__welcome">Salut Kiks 👋</p>

        <h2 className="hero-banner__title">
          Entre sport, sueur
          <span>et soirées arrosées.</span>
        </h2>

        <p className="hero-banner__description">
          Organise les prochains matchs, retrouve les sorties vélo et garde une
          trace de tous les bons moments des Co’Pintes.
        </p>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <strong>Kiks est en tête</strong>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <small>Défi en cours</small>
            <strong>3 services sur 5</strong>
          </div>
        </motion.div>
